...
using Abp.UI;
using MysqlMigrationDemo.Authentication.External;
...
using MysqlMigrationDemo.Models.TokenAuth;
using MysqlMigrationDemo.MultiTenancy;

namespace MysqlMigrationDemo.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : MysqlMigrationDemoControllerBase
    {
